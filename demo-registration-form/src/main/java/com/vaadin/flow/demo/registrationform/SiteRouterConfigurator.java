 ...
 * the License.
 */
package com.vaadin.flow.demo.registrationform;

import javax.servlet.annotation.WebServlet;

import com.vaadin.annotations.VaadinServletConfiguration;
import com.vaadin.flow.demo.registrationform.ui.RegistrationForm;
...
public class SiteRouterConfigurator implements RouterConfigurator {
    ...
    public void configure(RouterConfiguration configuration) {
        configuration.setRoute("", RegistrationForm.class);
    }
}
