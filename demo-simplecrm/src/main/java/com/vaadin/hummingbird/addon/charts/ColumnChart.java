...
public class ColumnChart extends AbstractComponent {
	...
	public void setTitle(String title) {
		this.getElement().getNode().enqueueRpc("$0.chart.setTitle({text: \""+title+"\"});",this.getElement());
	}
	
	public void setCategories(List<String> categories, int axisIndex) {
		this.getElement().getNode().enqueueRpc("$0.chart.axes[$1].setCategories($2);", this.getElement(), axisIndex, categories.toArray());
	}
