...
public class TextFieldUI extends UI {
    ...
    protected void init(VaadinRequest request) {
        ...
        tf.addChangeListener(e -> {
            // TODO Handle exception
            int age = Integer.parseInt(e.getNewValue());
            ...
            // TODO Should use component
            getElement().appendChild(ElementFactory.createDiv(text));
        });
        // TODO UI should have add
        getElement().appendChild(tf.getElement());
    }
