...
public class TextField extends Component {
    ...
    /**
     * Create a text field without a label.
     */
    public TextField() {
    ...
    /**
     * Adds a listener for {@link ChangeEvent}s, fired when the value of the
     * text field changes.
     *
    ...
    public EventRegistrationHandle addChangeListener(
        ...
        return inputElement.addEventListener("change",
                e -> changeListener.accept(new ChangeEvent(this, true)));
    }
}
