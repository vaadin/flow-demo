...
public class MainMenuView extends SimpleMenuView {
    ...
    public MainMenuView() {
        ...
        homeLink = createRouterLink("",
                Util.getPath(HomeView.class).orElse(null));
        ...
        addItem("Framework", FrameworkView.class);
        addItem("Elements", ElementsView.class);
        addItem("Pro Tools", (Class<? extends View>) null);
        addItem("Download", DownloadView.class);
        addItem("Community", CommunityView.class);
