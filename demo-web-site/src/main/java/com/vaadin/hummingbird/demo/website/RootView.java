...
import com.vaadin.hummingbird.router.ViewResolveResult;
import com.vaadin.server.DeploymentConfiguration;
import com.vaadin.server.ServiceException;
import com.vaadin.server.VaadinServlet;
import com.vaadin.server.VaadinServletService;

public class RootView extends SimpleView {
    /**
    ...
    public static class Servlet extends VaadinServlet {
        ...
        protected VaadinServletService createServletService(
            ...
            service.getRouter().setResolver(navigationEvent -> {
                ...
                switch (firstSegment) {
                case "":
                    return new ViewResolveResult(RootView.class, MainLayout.class);
                case "about":
                    return new ViewResolveResult(AboutView.class, AboutLayout.class,
                            MainLayout.class);
                case "dynamic":
                    // Only serve for /dynamic/{xyz}
                    if (location.getSegments().size() == 2) {
                        return new ViewResolveResult(DynamicView.class,
                                MainLayout.class);
                    } else {
                        return null;
                    }
