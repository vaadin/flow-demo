...
import com.vaadin.hummingbird.demo.webcomponent.polygit.component.VaadinComboBox;
...
public class RangeBubble extends Template {
    ...
    public RangeBubble() {
        ...
        rangeEnd.getElement().setProperty("value",
                Integer.toString(getModel().getEnd()));
        value.getElement().setPropertyJson("items", values);
        value.getElement().setProperty("value",
                Integer.toString(getModel().getValue()));
