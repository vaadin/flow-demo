...
public class MinesweeperComponent extends HtmlComponent {
    ...
    private void init() {
        ...
        getElement().synchronizeProperty("clicked", "clicked-change");
        getElement().addEventListener("clicked",
                e -> cellClick(e.getEventData()), "event.detail");

        getElement().synchronizeProperty("marked", "marked-change");
    ...
    private void cellClick(JsonObject object) {
        JsonObject json = object.get("event.detail");
